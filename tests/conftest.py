...
def invalid_token(func):

    def invaldiate_token(func, *args, **kwargs):
        pass
...
def channel_join_v2(user_token, channel_id):
...
def channel_messages_v2(user_token, channel_id, start):

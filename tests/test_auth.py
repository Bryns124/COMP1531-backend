...
# check that when you register it returns a unique user ID
# check that when register, login doesnt return input error if correct.
...
def test_password_length_less_than_6():
    with pytest.raises(InputError):
        assert auth_register_v1("bryanle@gmail.com", "pass", "Bryan", "Le")
    clear_v1()

# test when the name_first < 1
def test_first_name_length_less_than_1():
    with pytest.raises(InputError):
        assert auth_register_v1("bryanle@gmail.com", "password123", "", "Le")
    clear_v1()
        
# test when the name_first > 50
def test_first_name_length_more_than_50():
    with pytest.raises(InputError):
        assert auth_register_v1("bryanle@gmail.com", "password123", "qwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbn", "Le")
    clear_v1()
...
def test_last_name_length_more_than_50():
    with pytest.raises(InputError):
        assert auth_register_v1("bryanle@gmail.com", "password123", "Bryan", "qwertyuiopasdfghjklzxcvbnmqwertyuiopasdfghjklzxcvbn")
    clear_v1()